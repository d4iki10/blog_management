class Api::V1::ArticlesController < ApplicationController
  ...
  def index
    # 公開記事のみを取得
    articles = Article.where(status: 'published').includes(:category, :tags, :supervisor)
  ...
  def article_params
    params.require(:article).permit(:title, :topic, :slug, :category_id, :supervisor_id, tag_ids: [])
  end
